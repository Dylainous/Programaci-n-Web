...
$sql_total = "SELECT COUNT(*) AS total FROM alumno $where";
...
$sql = "SELECT * FROM alumno $where LIMIT $inicio, $registros_por_pagina";
...
<h2 align="center">LISTADO DE LOS ALUMNOS</h2>
...
<a href="buscar_alumnos.php">Limpiar</a>
</form>
...
if ($result->num_rows > 0) {
  ...
  while ($fila = $result->fetch_assoc()) {
    ...
    echo "<td>
            <form action='edicion_alumnos.php' method='get'>
    ...
    if ($fila['estado'] == 'Activo') {
      echo "<td>
              <form action='../server/cambiar_estado.php' method='post'
